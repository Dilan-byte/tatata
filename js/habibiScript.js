...
var gameEngine = { 
  ...
  updateLevel: function(levelNum) { // Update the level number in the game space and add to engine
    ...
    gmStatsLvlNumb.innerHTML = "Nivel " + gameEngine.levelNum;
  },
  ...
  timesUp: function() {
    ...
    lvlLostTtl.innerHTML = "Se Acabó El Tiempo";
  ...
  levelPassed: function() {
    ...
    lvlPssdTtl.innerHTML = "Nivel " + gameEngine.levelNum;
...
levelsEngine = {
  levels : [
    {
      levelNum: 1,
      time: 10, // Time in seconds for the current level
      tapValue: 4,
      tapsGoal: 5,
      goodCirclesCount: 1,
      evilCirclesCount: 4
  ...
  resetLevels: function() { // TODO
    levelsEngine.levels = [];
    levelsEngine.addNewLevel(1, 10, 3, 5, 1, 4);
  }
}
